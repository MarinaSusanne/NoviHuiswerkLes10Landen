...
async function fetchData(country) {
    ...
    try {
        ...
        const result = await (0, _axiosDefault.default).get(`https://restcountries.com/v2/name/${country}`);
...
function currencyCreator(currencies) {
    ...
    if (currencies.length === 2) return output + `${currencies[0].name} and ${currencies[1].name}`;
...
function languageCreator(languages) {
    ...
    } else return `${languages.join("and")}.`;
}
...
var Buffer = require("2c52ec35c8250ef2").Buffer;
"use strict";
/**
...
},{"2c52ec35c8250ef2":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("81aaddd7535ca2a6");
var ieee754 = require("7685ec0f57d8f30");
...
},{"81aaddd7535ca2a6":"eIiSV","7685ec0f57d8f30":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
